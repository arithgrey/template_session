  ...
  width: 17%;
                        ...
                        <header class="panel-heading custom-tab dark-tab">
                            <ul class="nav nav-tabs">
                                ...
                                <img id="imgarchivo" src="<?=base_url('application/img/general/book288.png')?>"> Archivos de su empresa </a>
                                </li>
                                          ...
                                          <div class='col-xs-12 col-sm-11'> 
                                              <div class="input-group">
                                                  <input type="text" name='nombrearchivo'  id="nombrearchivo" class="form-control"
                                                   placeholder="Organizaciones 2015, facturación 2013 , Educación primaria" aria-describedby="basic-addon2">
                                                  <span class="input-group-addon" 
                                                  id="basic-addon2">Nombre del archivo</span>  
                                            ...
                                            <div class='col-xs-12 col-sm-1'>
                                                ...
                                                <span class='textimgdescripcion'>Añadir descripción del archivo</span>
                                            </div> 
